...
// import com.eharrison.canary.zown.impl.Template;
//
...
// }
//
// public void loadTemplates() throws DatabaseReadException, DatabaseWriteException {
...
//
// final Template template = Template.create(templateDao.templateName);
// if (template == null) {
