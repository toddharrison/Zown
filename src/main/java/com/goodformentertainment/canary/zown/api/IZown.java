...
public interface IZown extends IConfigurable {
     ...
     *
     * @param welcomeMessage The String welcome message;
     */
     ...
     *
     * @param farewellMessage The String farewell message;
     */
     ...
     *
     * @param overridesConfiguration If this Zown overrides its Template.
